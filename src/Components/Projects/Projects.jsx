    ...
    <div className="mx-5 lg:mx-0 min-h-screen" id="Project">
      ...
      <div className="flex flex-col items-center justify-center">
        <div className="flex flex-col lg:flex-row lg:justify-between">
          ...
          <div className="card mx-5 glass mb-5 lg:mb-0">
            <div className="screenshot-container">
              <img src="/toy.png" alt="Screenshot 2" className="screenshot-img" />
            </div>
            <div className="card-body">
              <h2 className="card-title">THE TOY STORE</h2>
              <p>A toy store site that sells action figures.</p>
              <div className="technologies">
                <h2 className="card-title">Technologies:</h2>
                <p>
              ...
              <div className="flex flex-row card-actions">
                <a href="https://the-stores-7107d.web.app/" className="mx-auto bg-orange-400 p-2 rounded-lg">
                  Live Site
                </a>
                <a href="https://github.com/r03iuL/PHA-11-toy-store" className="mx-auto bg-orange-400 p-2 rounded-lg">
                  Frontend Code Github
                </a>
                <a href="https://github.com/r03iuL/PHA-11-toy-store-server" className="mx-auto bg-orange-400 p-2 rounded-lg">
                  Backend Code Github
                </a>
              </div>
            </div>
